...
The development of *Notably* was meticulously planned and executed following agile methodologies. This section outlines the user stories and epics that guided the development process, ensuring that each feature not only meets the users' expectations but also enriches their interaction with the app.

### Structuring Development with User Stories

At the heart of my agile planning were the User Stories - the narratives that captured the essence of what the users, both general visitors and registered members, sought from *Notably*. These stories facilitated a deep understanding of the audience's needs, guiding the development process from a user-centric perspective.
...
The primary goal of *Notably* is to :

Primary Audience: Programming students at educational institutions, coding bootcamps, and online courses who need a structured way to organize notes, collaborate on projects, and study for exams.
...
I want to create notes categorized by programming languages and topics (HTML, CSS, React, Agile methodologies, etc.) so I can easily organize my study materials.
I want to share my notes with classmates or make them public within the school community to enhance collaborative learning.
I need to search notes by specific programming keywords or categories to quickly find the information I need for studying or during projects.
...
I need to quickly understand how to navigate the app to start taking and organizing notes immediately.
I want to discover the most popular notes or categories within my study group to catch up or keep pace with my peers.
